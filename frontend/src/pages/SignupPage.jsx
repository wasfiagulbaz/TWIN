    ...
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] bg-bg animate-fade-in">
      ...
      <div className="flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-sm animate-slide-up">
          ...
          <h2 className="font-display text-2xl font-bold mb-2 text-text">Create your account</h2>
          <p className="text-text-muted text-[13.5px] mb-7">
            Start with <span className="text-accent font-bold">2 free searches</span> — upgrade anytime for unlimited access.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="signup-name" className="text-[12.5px] font-bold text-text">
                Name
              </label>
              <input
                id="signup-name"
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="signup-email" className="text-[12.5px] font-bold text-text">
                Email
              </label>
              <input
                id="signup-email"
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="signup-password" className="text-[12.5px] font-bold text-text">
                Password
              </label>
              <input
                id="signup-password"
